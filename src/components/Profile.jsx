...
function Profile() {
    return (
        <section className="m-5 p-5 pl-20 flex flex-col justify-end overflow-hidden">
            <h1 className="uppercase font-semibold text-5xl mb-10 animate-appear delay-100 fill-mode-forwards opacity-0">Anthony Mark Duane Battung</h1>
            ...
            <div className="flex mb-2 animate-appear delay-1000 fill-mode-forwards opacity-0">
                <a href="https://www.linkedin.com/in/anthony-mark-duane-battung-1a7059318" target="_blank" rel="noopener noreferrer"><LinkedIn className="fill-white w-11 h-min" /></a>
                <a href="https://github.com/amdbattung" target="_blank" rel="noopener noreferrer"><Github className="fill-white w-11 h-min ml-4" /></a>
                <a href="mailto:anthonymarkbattung@gmail.com"><Email className="fill-white w-11 h-min ml-4" /></a>
            </div>
        </section>
    )
}
